    ...
    <div className="about-page">
      ...
      <header className="hero-about">
        <div className="hero-about2">
          ...
          <p className="purpose-subtext">
            Every dish we serve is crafted with fresh ingredients, authentic flavors, and a passion for excellence. From our kitchen to your table, we focus on delivering a warm and memorable dining experience.
          </p>
          <p className="purpose-subtext">
          ...
          <button className="btn-ligh"
          onClick={scrollToOursTeam}
          >
            Meet our team
          </button>
